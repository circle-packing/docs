...
Een deel van de packings op Packomania hebben geen bijkomende publicatie.
...
In volgende tabellen wordt telkens het aantal cirkels in de kolom $N$ gegeven, de best gekende radius van op Packomania in kolom $Beste radius$ en de radius verkregen door mijn algoritme in kolom $Radius$.
...
Voor het circle-packing probleem met even grote cirkels worden de oplossingen voor $N=5$ tot $N=100$ in \autoref{table:packomania-equal} getoond.
Dit is slechts een subset van alle gekende oplossingen.
De volledige lijst voor dit probleem vind u in \autoref{append:packomania-equal}.
